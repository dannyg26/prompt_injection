...
- Amendment 2026-09-24 (project owner's decision, third): Part B in docs/PREREGISTRATION_LEAKAGE.md may be fit and scored once (resumable across Colab disconnects), as specified in its Amendment 3, only after its lock (results/leakage/PARTB_LOCK.json) matches a pushed commit. The unmet gates above must be reported as limitations.
