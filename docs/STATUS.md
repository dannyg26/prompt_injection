...
- Data audit: [BENCHMARK_AUDIT.md](BENCHMARK_AUDIT.md). The InjecGuard training file is clean against its public test files, but its validation set consists of test items (not described in the paper's arXiv v3). Attack sources are highly template-concentrated: 5,000 HackAPrompt rows form 6 groups.
